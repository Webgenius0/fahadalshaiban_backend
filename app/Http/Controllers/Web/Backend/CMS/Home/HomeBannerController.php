...
class HomeBannerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($counting >= 3) {
                return redirect()->back()->with('error', 'Maximum 3 Item You Can Add');
            }
            ...
            return redirect()->route('admin.cms.home.banner.index')->with('success', 'Created successfully');
        } catch (Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.cms.home.banner.index')->with('success', 'Updated successfully');
        } catch (Exception $e) {
            return redirect()->back()->with('error', $e->getMessage());
        }
    }
